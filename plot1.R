...
#plot 1
##hist(sub_data$Global_active_power, breaks=11, col="red")  the class is a factor and not numeric
##using only as.numeric gives incorrect values
png("plot1.png", width=480, height=480, units="px")
hist(as.numeric(as.character(sub_data$Global_active_power)), col="red", main="Global Active Power",
